...
export default function CardPanel({ children, id, title, highlightWord }) {
  return (
    <section id={id} className="relative py-16 px-4 group bg-c">
      ...
      <div className={cn("bg-card hover:bg-card-hover backdrop-blur-sm border border-border rounded-xl p-8 shadow-lg",
        "group-hover:shadow-primary/20 dark:group-hover:shadow-primary/30 max-w-5xl mx-auto")}>
